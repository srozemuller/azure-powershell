...
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20200301Preview.IAccount])]
...
param(
    ...
    [Parameter()]
    [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.Purview.Support.ResourceIdentityType])]
    ...
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.Purview.Category('Body')]
    [Microsoft.Azure.PowerShell.Cmdlets.Purview.Runtime.Info(PossibleTypes=([Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20200301Preview.ITagUpdateTags]))]
