...
external help file:
Module Name: Purview
online version: https://docs.microsoft.com/powershell/module/purview/get-azpurviewaccount
schema: 2.0.0
---
...
### List (Default)
```
Get-AzPurviewAccount [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### List1
```
Get-AzPurviewAccount -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20200301Preview.IAccount
